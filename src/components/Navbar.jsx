...
export const Navbar = () => {
	...
	return (
		<nav className='fixed z-40 flex w-full items-center justify-between bg-black/40 px-6 py-4 text-white'>
			<h1 className='mr-6 w-[250px] font-prompt text-xl tracking-wider lg:text-3xl'>
				Tomstal.
			</h1>
			...
			<div
				...
				<h1 className='p-6 font-prompt text-3xl tracking-wider'>Tomstal.</h1>
