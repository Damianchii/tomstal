...
export const Videosection = () => {
	return (
		<header class='relative flex h-screen items-center justify-center overflow-hidden'>
			<div class='relative z-30 rounded-xl p-5 text-center text-white'>
			...
			<video
				...
				muted
				width='100%'
				class='object-fit pointer-events-none absolute z-10 min-h-full w-auto min-w-full max-w-none select-none'>
